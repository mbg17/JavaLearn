                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="${pageContext.request.contextPath}/product/detail.do?id=${product.id}"><button type="button" class="btn bg-olive btn-xs">详情</button></a>
                                    <a href="${pageContext.request.contextPath}/product/alter.do?id=${product.id}"><button type="button" class="btn bg-olive btn-xs">编辑</button></a>
                                </td>
                            </tr>
                            </c:forEach>
